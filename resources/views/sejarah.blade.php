...
<head>
    ...
    <title> Sejarah Desa Bukian</title>
    ...
    <div class="max-w-3xl px-4 pt-6 lg:pt-10 pb-12 sm:px-6 lg:px-8 mx-auto">
        ...
        <div class="max-w-2xl">
            ...
            <div class="space-y-5 md:space-y-8 mb-[100px]">
                <div class="space-y-3">
                    <h2 class="text-2xl font-bold md:text-3xl text-center">Sejarah Desa Bukian</h2>
                </div>

                <p class="text-lg text-justify lg:indent-8 text-gray-800">Berkat Asung Kerta  Waranugraha Ida Sang Hyang Widhi Wasa / Tuhan Yang Maha Esa,maka dapatlah kami susun sejarah asal mula Payangan ini khususnya Desa Bukian  semoga saja “tan kakeneng sosodning sapa muang upadrawa“ atas kelancangan untuk menyebut nama beliau yang sudah Awur ring Acintya.</p>

                <figure>
                    <img class="w-full object-cover rounded-xl"
                        src="https://www.topijelajah.com/wp-content/uploads/2021/01/Desa-Bukian.jpg"
                        alt="Blog Image">
                ...
                <div class="ml-8">
                  <ul class="list-disc list-outside space-y-5 ps-5 text-lg text-gray-800 ">
                      <li class="ps-2">Banjar Dinas Bukian</li>
                      <li class="ps-2">Banjar Dinas Bukian Kaja</li>
                      <li class="ps-2">Banjar Dinas Bukian Kawan</li>
                      <li class="ps-2">Banjar Dinas Subilang</li>
                      <li class="ps-2">Banjar Dinas Lebah A</li>
                      <li class="ps-2">Banjar Dinas Lebah Buana</li>
                      <li class="ps-2">Banjar Dinas Tiyingan</li>
                      <li class="ps-2">Banjar Dinas Ulapan</li>
                      <li class="ps-2">Banjar Dinas Tangkup</li>
                      <li class="ps-2">Banjar Dinas Amo</li>
                      <li class="ps-2">Banjar Dinas Dasong</li>
                  </ul>
                </div>
                
                <p class="text-lg text-justify lg:indent-8 text-gray-800">Dan kemudian dengan adanya Perkembangan jumlah Penduduk serta Luas Wilayah yang memungkinkan seperti tertuang dalam  Undang – undang Nomor : 5 Tahun 1979,  Tentang Pemerintahan Desa ( Lembaran Negara Republik Indonesia Tahun 1979 Nomor : 56 Tambahan Lembaran Negara Republik Indonesia Nomor : 3135 ) Demikan sejarah singkat Desa Bukian, dapat kami uraikan dan sudah barang tentu dalam uraian diatas banyak hal yang perlu harus di sempurnakan lagi agar generasi berikutnya mengetahui sejarah Bukian  yang jelas dan pasti. Perlu di ketahui dalam penulisan sejarah ini sudah barang tentu ada ketimpangan, karena dalam hal ini rata- rata bersumber dari cerita-cerita secara turun temurun yang sampai saat ini belum ada yang membukukan.     
                  </p>
