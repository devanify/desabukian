    ...
    <div class="max-w-3xl px-4 pt-6 lg:pt-10 pb-12 sm:px-6 lg:px-8 mx-auto">
        ...
        <div class="max-w-2xl">
            ...
            <div class="space-y-5 md:space-y-8 mb-[100px]">
                <div class="space-y-3">
                    <h2 class="text-2xl font-bold md:text-3xl">Sejarah Desa Bukian</h2>
                </div>

                <p class="text-lg text-justify indent-8 text-gray-800">Berkat Asung Kerta  Waranugraha Ida Sang Hyang Widhi Wasa / Tuhan Yang Maha Esa,maka dapatlah kami susun sejarah asal mula Payangan ini khususnya Desa Bukian  semoga saja “tan kakeneng sosodning sapa muang upadrawa“ atas kelancangan untuk menyebut nama beliau yang sudah Awur ring Acintya.</p>
