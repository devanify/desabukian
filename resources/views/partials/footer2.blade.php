<footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto sid d-block">
  <!-- Grid -->
  <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-5">
    <div>
      <a class="flex-none text-xl font-semibold text-black focus:outline-none" href="#" aria-label="Brand">Desa Bukian</a>
    </div>
    <!-- End Col -->
