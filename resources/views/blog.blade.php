...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto mb-[100px]">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      @foreach ($post as $p )
        <!-- Card -->
      <a class="group flex flex-col h-full border border-gray-200 hover:border-transparent hover:shadow-lg focus:outline-none focus:border-transparent focus:shadow-lg transition duration-300 rounded-xl p-5" href="{{ route('article',$p->slug) }}">
        <div class="aspect-w-16 aspect-h-11">
          <img class="w-full object-cover rounded-xl" src="{{asset('assets/image/posts/'.$p->image_url) }}" alt="Blog Image">
        </div>
        <div class="my-6">
